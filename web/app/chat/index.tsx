...
export default function Index() {
  ...
  // Looks cool! Now give me a Landing view to show when the user is not logged in.
  // In a real app, replace this with an actual WebSocket/socket.io client
  // or a real-time backend service.
  useEffect(() => {
